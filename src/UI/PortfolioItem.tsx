...
export default function PortfolioItem({ title, subTitle, link, images }: PortfolioItemProps) {
    return (
        <div className="bg-[rgba(255,255,255,0.08)] rounded-[16px] overflow-hidden">
            ...
            <div className="p-[16px] flex flex-col gap-[15px] pt-[30px]">
                ...
                <Link href={link} target="_blank" className="text-white font-lato font-[700] text-[16px] leading-[16px] bg-[linear-gradient(129deg,_#fd6f00_0%,_#e46400_100%)] rounded-[8px] p-[14px] w-max">посетить сайт</Link>
            </div>
        </div>
    )
}